  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      qrLayout: {
        ...
        productPhotoWidth: 150,
        productPhotoHeight: 150,
        productPhotoX: 0,
        productPhotoY: -200,
        productPhotoRoundness: 100,
        includeGarmentName: true,
        garmentNameWidth: 300,
        garmentNameHeight: 50,
        garmentNameX: 0,
        garmentNameY: 150,
        garmentNameRotation: 0,
        garmentNameFontFamily: 'Inter, sans-serif',
        garmentNameFontSize: 48,
        garmentNameFontWeight: '600',
        garmentNameFontColor: '#000000',
        garmentNameTextAlign: 'center',
        garmentNameTextVerticalAlign: 'middle',
      }
    },
  })
